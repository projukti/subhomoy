...
<div class="content">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12"><h4 class="page-title">Manage Portfolio</h4>
                        <ol class="breadcrumb">
                ...
                <div class="row">
                    <div class="col-sm-12">
					<?php echo anchor('admin/manage_slider/add', 'Add Portfolio', 'title="Add Portfolio" class="btn btn-default waves-effect waves-light"');?>
                        <div class="card-box">
                        	<div id="message">
